...
func TestNewSchemeRegistry_RegisterAndUnregister(t *testing.T) {
	// Register a new scheme (Discover)
	discoverScheme := NewScheme(
		SchemeNameDiscover,
		SchemeTypeDiscover,
	...
	reg, err := NewSchemeRegistry(RegisterScheme(discoverScheme))
	if err != nil {
...
func TestValidateCard(t *testing.T) {
	...
	tests = append(tests,
		testCase{
			name:      "Valid Discover",
			card:      Card{Number: "6011000990139424", Code: strPtr("123")},
			wantValid: true,
			wantType:  SchemeTypeDiscover,
		},
		testCase{
			name:      "Valid JCB",
			card:      Card{Number: "3530111333300000", Code: strPtr("123")},
			wantValid: true,
			wantType:  SchemeTypeJcb,
		},
		testCase{
			name:      "Valid UnionPay",
			card:      Card{Number: "6240008631401148", Code: strPtr("123")},
			wantValid: true,
			wantType:  SchemeTypeUnionPay,
		},
		testCase{
			name:      "Valid Maestro",
			card:      Card{Number: "6759649826438453", Code: strPtr("123")},
			wantValid: true,
			wantType:  SchemeTypeMaestro,
		},
		testCase{
			name:      "Valid Diners Club",
			card:      Card{Number: "30569309025904", Code: strPtr("123")},
			wantValid: true,
			wantType:  SchemeTypeDiners,
		},
		testCase{
			name:      "Valid Mastercard 2-series",
			card:      Card{Number: "2221000000000009", Code: strPtr("123")},
			wantValid: true,
			wantType:  SchemeTypeMastercard,
		},
		testCase{
			name:      "Valid Amex (alternate)",
			card:      Card{Number: "371449635398431", Code: strPtr("1234")},
			wantValid: true,
			wantType:  SchemeTypeAmex,
		},
		testCase{
			name:      "Valid Discover (alternate)",
			card:      Card{Number: "6011111111111117", Code: strPtr("123")},
			wantValid: true,
			wantType:  SchemeTypeDiscover,
		},
		testCase{
			name:      "Valid JCB (alternate)",
			card:      Card{Number: "3566002020360505", Code: strPtr("123")},
			wantValid: true,
			wantType:  SchemeTypeJcb,
		},
		testCase{
		...
		testCase{
			...
			card:      Card{Number: "38520000023237", Code: strPtr("123")},
			wantValid: true,
			wantType:  SchemeTypeDiners,
		},
		// Invalid/edge cases
		testCase{
			...
			card:      Card{Number: "6240008631401148", Code: strPtr("12")},
			wantValid: false,
		},
		testCase{
			name:      "Invalid Maestro (Luhn fail)",
			card:      Card{Number: "6759649826438454", Code: strPtr("123")},
			wantValid: false,
		},
		testCase{
			name:      "Invalid Diners Club (wrong code length)",
			card:      Card{Number: "30569309025904", Code: strPtr("12")},
			wantValid: false,
		},

		testCase{
			name:      "Valid Visa",
			card:      Card{Number: "4111111111111111", Code: strPtr("123")},
			wantValid: true,
			wantType:  SchemeTypeVisa,
		},
		testCase{
			name:      "Valid Mastercard",
			card:      Card{Number: "5555555555554444", Code: strPtr("123")},
			wantValid: true,
			wantType:  SchemeTypeMastercard,
		},
		testCase{
			name:      "Valid Amex",
			card:      Card{Number: "378282246310005", Code: strPtr("1234")},
			wantValid: true,
			wantType:  SchemeTypeAmex,
		},
		testCase{
			name:      "Invalid Visa (wrong code length)",
			card:      Card{Number: "4111111111111111", Code: strPtr("12")},
			wantValid: false,
		},
		testCase{
			name:      "Invalid Mastercard (wrong number)",
			card:      Card{Number: "5555555555554440", Code: strPtr("123")},
			wantValid: false,
		},
		testCase{
			name:      "Invalid Amex (wrong code length)",
			card:      Card{Number: "378282246310005", Code: strPtr("123")},
			wantValid: false,
		},
		testCase{
			name:      "Unknown scheme",
			card:      Card{Number: "9999999999999999", Code: strPtr("123")},
			wantValid: false,
		},
	)
